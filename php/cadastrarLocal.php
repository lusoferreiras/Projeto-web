...
$codigo_parceiro=$_GET['codigo_parceiro'];


$query="insert into endereco_parceiros values ('$bairro_parceiro','$rua_parceiro','$numero_parceiro','$lote_parceiro','$codigo_parceiro')"; //Instrução SQL que será executada
